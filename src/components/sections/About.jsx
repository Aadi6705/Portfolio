        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start about-reveal">
          <div className="lg:col-span-8">
            <p className="font-sans text-body-mob md:text-body text-ink leading-relaxed">
              I am a final/third-year Computer Science &amp; Business Systems student at SRM Institute of Science and Technology, Chennai, with a strong foundation in software engineering, data science, and artificial intelligence.
            </p>
            <p className="mt-4 font-sans text-body-mob md:text-body text-slate leading-relaxed">
              My technical work spans end-to-end full-stack web application development and machine learning, with a focus on explainability and actionable metrics. I have hands-on experience designing modular architectures, training predictive models (such as XGBoost and SHAP explainability pipelines), and building clean, responsive interfaces.
            </p>
            <p className="mt-4 font-sans text-body-mob md:text-body text-slate leading-relaxed">
              Combining core computer science principles with business systems awareness, I aim to build reliable, high-performance software systems that solve real-world problems cleanly and transparently.
            </p>
          </div>
